...
![image](http://wuttinan.com/assets/github.png)
...
* `/_includes` กับ `/_layouts` นี่เก็บไฟล์ html ของหน้าบล็อก ใครจะแก้หน้าตายังไงมาแก้ตรงนี้ ส่วนไฟล์ css จะอยู่ที่ `/public`
